...
class _app {
  ...
  brandDescription = [ 'Owned by Reaper', 'Co-Owner of somnia.cc', 'Shoutouts to:', 'Noodles aka. Kokain', 'Riiterlean aka. Niils', 'Yolo$Gman aka. $iggi', 'Ekelhafte aka. $chaenderin','And to Perms', 'Discord: reaper#0001'];
